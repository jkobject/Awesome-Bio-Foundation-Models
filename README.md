...
![Stars](https://img.shields.io/github/stars/apeterswu/Awesome-Bio-Foundation-Models?color=yellow&labelColor=555555)

</div>

The repository is a collection of awesome bio-foundation modeling papers,
various domains include DNA, RNA, gene, protein, single-cell, and
multimodalities.
...
![](https://img.shields.io/badge/Paper_Publisher-5291C8?style=flat&logo=Read.cv&labelColor=555555)
paper publisher with paper link

![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)
code link

![Model](https://img.shields.io/badge/Model-5291C8?style=flat&logo=themodelsresource&labelColor=555555)
model link
...
- **GPN-MSA: an alignment-based DNA language model for genome-wide variant
  effect prediction**
...
- **DNAGPT: A Generalized Pre-trained Tool for Multiple DNA Sequence Analysis
  Tasks**
...
- **EMDLP: Ensemble multiscale deep learning model for RNA methylation site
  prediction**
...
- **(RNA-FM) Interpretable RNA Foundation Model from Unannotated Data for Highly
...
- **(RNABERT) Informative RNA base embedding for RNA structural alignment and
...
- **(MRM-BERT) Prediction of Multiple Types of RNA Modifications via Biological
  Language Model**
...
- **(SpliceBERT) Self-supervised learning on millions of pre-mRNA sequences
...
- **xTrimoGene: An Efficient and Scalable Representation Learner for Single-Cell
  RNA-Seq Data**
...
- **(RNA-MFM) Multiple sequence alignment-based RNA language model and its
...
- **ATOM-1: A Foundation Model for RNA Structure and Function Built on Chemical
  Mapping Data**
...
- **RNAformer: A Simple Yet Effective Deep LearningModel for RNA Secondary
...
- **scDisInFact: disentangled learning for integration and prediction of
  multi-batch multi-condition single-cell RNA-sequencing data**
...
- **(UniRep) Unified rational protein engineering with sequence-based deep
...
- **(ESM-1v) Language models enable zero-shot prediction of the effects of
...
- **(ESM-2 & ESMFold) Language models of protein sequences at the scale of
  evolution enable accurate structure prediction**
...
- **(AntiBERTa) Deciphering the language of antibodies using self-supervised
  learning**
...
- **(GearNet) Protein Representation Learning by Geometric Structure
  Pretraining**
...
- **(CARP) Convolutions are competitive with transformers for protein sequence
  pretraining**
...
- **(HelixFold-Single) A method for multiple-sequence-alignment-free protein
  structure prediction using a protein language model**
...
- **(ABGNN) Pre-training Antibody Language Models for Antigen-Specific
...
- **(ReprogBert) Reprogramming Pretrained Language Models for Antibody Sequence
  Infilling**
...
- **ProteinFlow: a Python Library to Pre-Process Protein Structure Data for Deep
...
- **xTrimoPGLM: Unified 100B-Scale Pre-trained Transformer for Deciphering the
  Language of Protein**
...
- **ProLLaMA: A Protein Large Language Model for Multi-Task Protein Language
  Processing**
...
- **(ESM-GearNet) A Systematic Study of Joint Representation Learning on Protein
...
- **(ProteinINR) Pre-training Sequence, Structure, and Surface Features for
  Comprehensive Protein Representation Learning**
...
- **(CaLM) Codon language embeddings provide strong signals for use in protein
  engineering**
...
- **PLMSearch: Protein language model powers accurate and fast sequence search
  for remote homology**
...
- **Prot2Token: A multi-task framework for protein language processing using
...
- **Fine-tuning protein language models boosts predictions across diverse
  tasks**
...
- **OpenFold: retraining AlphaFold2 yields new insights into its learning
...
- **ProteinInvBench: Benchmarking Protein Inverse Folding on Diverse Tasks,
  Models, and Metrics**
...
- **ProteinShake: Building datasets and benchmarks for deep learning on protein
  structures**
...
- **An end-to-end framework for the prediction of protein structure and fitness
...
- **(DCell) Using deep learning to model the hierarchical structure and function
  of a cell**
...
- **A sandbox for prediction and integration of DNA, RNA, and proteins in single
  cells**
...
- **(DPI) Modeling and analyzing single-cell multimodal data with deep
  parametric inference**

  [![](https://img.shields.io/badge/Bioinformatics_2023-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://academic.oup.com/bib/article/24/1/bbad005/6987655)
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/studentiz/dpi)
  [![Stars](https://img.shields.io/github/stars/studentiz/dpi?color=yellow&style=social)](https://github.com/studentiz/dpi)

- **(ScPROTEIN) A Versatile Deep Graph Contrastive Learning Framework for
  Single-cell Proteomics Embedding**

  [![](https://img.shields.io/badge/Nature_Methods_2024-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://www.nature.com/articles/s41592-024-02214-9)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2Fca14faebe3a707a2c72583c48b5e66b9f4a770ef%3Ffields%3DcitationCount&query=%24.citationCount&label=citation&style=social&labelColor=555555&color=ED8936)
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/TencentAILabHealthcare/scPROTEIN)
  [![Stars](https://img.shields.io/github/stars/TencentAILabHealthcare/scPROTEIN?color=yellow&style=social)](https://github.com/TencentAILabHealthcare/scPROTEIN)
...
- **scGPT: toward building a foundation model for single-cell multi-omics using
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/bowang-lab/scGPT)
...
- **scPRINT: pre-training on 50 million cells allows robust gene network
  predictions**

  [![](https://img.shields.io/badge/Nature_Communications_2025-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://www.nature.com/articles/s41467-025-58699-1)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2Fbe9b88e552d3684c137fea0bafd91fd5c303a20f%3Ffields%3DcitationCount&query=%24.citationCount&label=citations&style=social)
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/cantinilab/scPRINT)
  [![Stars](https://img.shields.io/github/stars/cantinilab/scPRINT?color=yellow&style=social)](https://github.com/cantinilab/scPRINT)
  [![Model](https://img.shields.io/badge/Model-5291C8?style=flat&logo=themodelsresource&labelColor=555555)](https://github.com/cantinilab/scPRINT)

- **scPRINT-2: Towards the next-generation of cell foundation models and
  benchmarks**

  [![](https://img.shields.io/badge/BioRxiv_2025-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://www.biorxiv.org/content/10.64898/2025.12.11.693702v2)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2F6ac8807516b3a8c23e89f28c2766a0d26914f664%3Ffields%3DcitationCount&query=%24.citationCount&label=citations&style=social)
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/cantinilab/scPRINT-2)
  [![Stars](https://img.shields.io/github/stars/cantinilab/scPRINT-2?color=yellow&style=social)](https://github.com/cantinilab/scPRINT-2)
  [![Model](https://img.shields.io/badge/Model-5291C8?style=flat&logo=themodelsresource&labelColor=555555)](https://github.com/cantinilab/scPRINT-2)

- **scMulan: a multitask generative pre-trained language model for single-cell
  analysis**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/SuperBianC/scMulan)
...
- **scDiffusion: conditional generation of high-quality single-cell data using
  diffusion model**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/EperLuo/scDiffusion)
...
- **Cell2Sentence: Teaching Large Language Models the Language of Biology**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/vandijklab/cell2sentence-ft)
...
- **CellPLM: Pre-training of Cell Language Model Beyond Single Cells**
  ...
  [![](https://img.shields.io/badge/ICLR_2024-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://openreview.net/forum?id=BKXvPDekud)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2Fb1e90b67675b6d7ae88b563a93cb4d375857cb15%3Ffields%3DcitationCount&query=%24.citationCount&label=citation&style=social&labelColor=555555&color=ED8936)
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/OmicsML/CellPLM)
  [![Stars](https://img.shields.io/github/stars/OmicsML/CellPLM?color=yellow&style=social)](https://github.com/OmicsML/CellPLM)
...
- **BioSeq-BLM: a platform for analyzing DNA, RNA and protein sequences based on
...
- **Galactica: A Large Language Model for Science**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/paperswithcode/galai)
...
- **BioT5: Enriching Cross-modal Integration in Biology with Chemical Knowledge
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/QizhiPei/BioT5)
...
- **DARWIN Series: Domain Specific Large Language Models for Natural Science**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/MasterAI-EAM/Darwin)
...
- **(scMoFormer) Single-Cell Multimodal Prediction via Transformers**
  ...
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/OmicsML/scMoFormer)
  [![Stars](https://img.shields.io/github/stars/OmicsML/scMoFormer?color=yellow&style=social)](https://github.com/OmicsML/scMoFormer)

- **BioT5+: Towards Generalized Biological Understanding with IUPAC Integration
...
- **ChatCell: Facilitating Single-Cell Analysis with Natural Language**
  ...
  [![](https://img.shields.io/badge/Arxiv_2024-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://www.nature.com/articles/s41467-023-36720-9)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2F6a3c0c897870c4f1897d2af0b88981fa2764359b%3Ffields%3DcitationCount&query=%24.citationCount&label=citation&style=social&labelColor=555555&color=ED8936)
  [![](https://img.shields.io/badge/code-38C26D?style=flat&logo=GitHub&labelColor=555555)](https://github.com/zjunlp/ChatCell)
...
- **Deep Learning for Genomics: From Early Neural Nets to Modern Large Language
  Models**
...
- **Leveraging Biomolecule and Natural Language through Multi-Modal Learning: A
  Survey**
...
- **Machine learning for functional protein design**
  ...
  [![](https://img.shields.io/badge/Nature_Biotechnology_2024-5291C8?style=flat&logo=Read.cv&labelColor=555555)](https://www.nature.com/articles/s42256-024-00836-4)
  ![Dynamic JSON Badge](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fapi.semanticscholar.org%2Fgraph%2Fv1%2Fpaper%2Fdd7d683a49a126b441363e066ce255dc87b0383e%3Ffields%3DcitationCount&query=%24.citationCount&label=citation&style=social&labelColor=555555&color=ED8936)
